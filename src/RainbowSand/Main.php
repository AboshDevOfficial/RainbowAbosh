...
class Main extends PluginBase {
	...
	public function onEnable() 
	{
		...
		Entity::registerEntity(RainbowAbosh::class);
	   	...
	   	if(self::$level === $server->getDefaultLevel()->getSafeSpawn()) {
			...
			if(self::$customBlock === "true"){
				...
				if(self::$customBlock === "false"){
					...
					$sand = Entity::createEntity("RainbowAbosh", self::$level->getChunk($randX >> 4, $randZ >> 4), $nbt);
					return $sand;
				}
			}
		}
